    ...
    <div className="min-h-screen bg-[#090d16] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 rounded-2xl border border-white/5 bg-gray-900/60 backdrop-blur-xl shadow-2xl relative">
        ...
        <h2 className="text-2xl font-bold text-center text-white mb-2">
          {requiresMfa ? 'Multi-Factor Verification' : 'Welcome to TrustArmor'}
        </h2>
        <p className="text-gray-400 text-sm text-center mb-8">
          {requiresMfa ? 'Enter the code from your authenticator app' : 'Access your governance, risk, and compliance workspace'}
        </p>
          ...
          <form onSubmit={handleVerifyMFA} className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="123456"
                className="w-full text-center tracking-[0.5em] font-mono py-3 px-4 bg-gray-950/50 border border-white/10 rounded-xl focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-white outline-none transition text-xl"
              />
            </div>
